---
url: "https://agflow.agrisk.dev/pt/flow/67bf0dccb38591aeceff8121/card/69fdf5782c973ce220c44940/credit-analysis/credit-engine"
path: "/pt/flow/67bf0dccb38591aeceff8121/card/69fdf5782c973ce220c44940/credit-analysis/credit-engine"
fase: 4
fase_nome: "Análise de Crédito"
modulo: "Análise de Crédito"
topico: "Motor de crédito"
crawledAt: "2026-05-08T18:36:37.088Z"
...
![[fase4-credit-analysis-credit-engine.png]]
...
| button | `[aria-label="Open"]` | `page.getByRole('button', { name: 'Open' })` | button |
| Analisar cliente | `button:has-text("Analisar cliente")` | `page.getByRole('button', { name: 'Analisar cliente' })` | button |
