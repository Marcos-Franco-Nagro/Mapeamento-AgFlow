---
url: "https://agflow.agrisk.dev/pt/flow/67bf0dccb38591aeceff8121/card/69fdf5782c973ce220c44940/credit-analysis/credit-opinion"
path: "/pt/flow/67bf0dccb38591aeceff8121/card/69fdf5782c973ce220c44940/credit-analysis/credit-opinion"
fase: 4
fase_nome: "Análise de Crédito"
modulo: "Análise de Crédito"
topico: "Parecer de crédito"
crawledAt: "2026-05-08T18:36:47.178Z"
...
![[fase4-credit-analysis-credit-opinion.png]]
...
| Gerar análise | `button:has-text("Gerar análise")` | `page.getByRole('button', { name: 'Gerar análise' })` | button |
...
| Realizar parecer | `button:has-text("Realizar parecer")` | `page.getByRole('button', { name: 'Realizar parecer' })` | button |
